function CustomTab() {
  return (
    <div className="tabs tabs-lift w-[85%] mx-auto z-10 my-7 mt-10">
      ...
      <label className="tab px-8 text-md h-13 bg-[rgba(38,165,97,1)] text-white border-[rgba(38,165,97,1)] rounded-t-2xl">
      ...
      <label className="tab mx-2 px-8 text-md h-13 bg-[#DDD8E5] rounded-t-2xl">
      ...
      <label className="tab px-8 text-md h-13 bg-[#DDD8E5] rounded-t-2xl">
        <input type="radio" name="my_tabs_4" />
