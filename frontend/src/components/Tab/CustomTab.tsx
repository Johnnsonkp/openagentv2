function CustomTab() {
  return (
    <div className="tabs tabs-lift w-[95%] sm:w-[90%] md:w-[85%] mx-auto z-10 my-5 sm:my-7 mt-6 sm:mt-10">

      <label className="tab px-3 sm:px-6 md:px-8 text-xs sm:text-sm md:text-md h-11 sm:h-12 md:h-13 bg-[rgba(38,165,97,1)] text-white border-[rgba(38,165,97,1)] rounded-t-2xl hover:bg-[rgba(38,165,97,1)]">
        <input type="radio" name="my_tabs_4" />
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18" strokeWidth="1.5" width="16" height="16" stroke="currentColor" className="w-4 h-4 sm:w-5 sm:h-5 me-1 sm:me-2" data-category="Hero" data-subcategory="Hero Search Tabs" data-eventvaluetype="Selling" data-eventvalue="Selling"><path d="m10 3.485 5 4.523v7.852h-2V9.828H7v6.032H5V8.008zM10 .78 0 9.828h3v8.042h6V11.84h2v6.031h6V9.828h3z"></path></svg>

        <span className="hidden xs:inline">Selling</span>
      ...
      <div className="tab-content bg-base-100 border-base-300">
        <form action="/search" className="w-full px-0">
          <div className="relative">
            <input type="text" name="q" className="w-full border border-white h-12 sm:h-14 md:h-15 shadow p-3 sm:p-4 rounded-xl text-sm sm:text-base" placeholder="search" />

            <button type="submit" className="bg-[rgba(38,165,97,1)] w-9 sm:w-10 md:w-11 h-[70%] absolute top-2 sm:top-2.5 right-2 sm:right-3 rounded-md">
              <svg className="text-white h-4 w-4 sm:h-5 sm:w-5 fill-current mx-auto my-auto"
      ...
      <label className="tab flex align-middle px-3 sm:px-6 md:px-8 text-xs sm:text-sm md:text-md h-11 sm:h-12 md:h-13 bg-[#DDD8E5] rounded-t-2xl hover:bg-[rgba(38,165,97,1)] hover:text-white">
        <input type="radio" name="my_tabs_4" />
